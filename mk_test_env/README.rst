...
========================================
|icon| Manage Test Environment 7.0.0.1.2
========================================


**Create, update or clean-up test environment**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/zerobug-test/7.0/mk_test_env/static/src/img/icon.png
...
* |menu| Setting > Local Modules |right_do| Select **mk_test_env** > Install
...
* |menu| Setting > Modules > Update Modules List
* |menu| Setting > Local Modules |right_do| Select **mk_test_env** > Update

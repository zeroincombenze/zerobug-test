...
.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/zerobug-test/10.0/test_odoo_score_2/static/description/icon.png
...
`odoo_score <https://github.com/zeroincombenze/tools>` package.
This is contains some tests tests to validate odoo_score and Odoo modules.
...
Contiene una serie di test complessido_mig   per validare odoo_score e i moduli Odoo.
...
* |menu| Setting > Apps |right_do| Select **test_odoo_score_2** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **test_odoo_score_2** > Update

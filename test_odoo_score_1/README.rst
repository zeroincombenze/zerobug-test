...
=================================
|icon| Test Odoo score 10.0.0.1.0
=================================


**odoo_score test suite**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/zerobug-test/10.0/test_odoo_score_1/static/description/icon.png
...
This module is part of test suite for
`odoo_score <https://github.com/zeroincombenze/tools>` package. This is the first test;
it contains simple tests to validate odoo_score and Odoo modules.


|

|it| Questo è un modulo tecnico che non ha alcuna utilità per l'utente finale.
Il modulo è fornito soltanto con documentazione in inglese.

Questo modulo fa parte della suite per il test del package
`odoo_score <https://github.com/zeroincombenze/tools>`.
Contiene una serie di test semplici per validare odoo_score e i moduli Odoo.
...
* |menu| Setting > Apps |right_do| Select **test_odoo_score_1** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **test_odoo_score_1** > Update

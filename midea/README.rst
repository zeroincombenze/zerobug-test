============================
|icon| midea/Midea 9.0.0.1.7
============================

**z0bug_odoo test suite**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/zerobug-test/9.0/midea/static/description/icon.png
...
.. |thumbnail| image:: https://raw.githubusercontent.com/zeroincombenze/zerobug-test/9.0/midea/static/description/description.png
...
::
    ...
    deploy_odoo clone -r zerobug-test -b 9.0 -G zero -p $HOME/9.0
    # Upgrade virtual environment
    vem amend $HOME/9.0/venv_odoo
...
::
    ...
    deploy_odoo update -r zerobug-test -b 9.0 -G zero -p $HOME/9.0
    vem amend $HOME/9.0/venv_odoo

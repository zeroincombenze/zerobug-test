...
.. |thumbnail| image:: https://raw.githubusercontent.com/zeroincombenze/zerobug-test/8.0/midea/static/description/description.png
...
::
    ...
    deploy_odoo clone -r zerobug-test -b 8.0 -G zero -p $HOME/8.0
...
::
    ...
    deploy_odoo update -r zerobug-test -b 8.0 -G zero -p $HOME/8.0
    vem amend $HOME/8.0/venv_odoo
